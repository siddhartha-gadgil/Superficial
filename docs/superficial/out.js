...
/** @constructor */
function $c_Lsuperficial_Web$() {
  $c_O.call(this)
}
$c_Lsuperficial_Web$.prototype = new $h_O();
$c_Lsuperficial_Web$.prototype.constructor = $c_Lsuperficial_Web$;
/** @constructor */
function $h_Lsuperficial_Web$() {
  /*<skip>*/
}
$h_Lsuperficial_Web$.prototype = $c_Lsuperficial_Web$.prototype;
$c_Lsuperficial_Web$.prototype.main__V = (function() {
  var jsDiv = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("js-div");
  jsDiv.appendChild($as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().stringFrag__T__Lscalatags_JsDom$StringFrag("time to be superficial")])).render__Lorg_scalajs_dom_raw_Element())
});
$c_Lsuperficial_Web$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lsuperficial_Web$.prototype.init___ = (function() {
  $c_O.prototype.init___.call(this);
  $n_Lsuperficial_Web$ = this;
  return this
});
$c_Lsuperficial_Web$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lsuperficial_Web$ = new $TypeData().initClass({
  Lsuperficial_Web$: 0
}, false, "superficial.Web$", {
  Lsuperficial_Web$: 1,
  O: 1
});
$c_Lsuperficial_Web$.prototype.$classData = $d_Lsuperficial_Web$;
var $n_Lsuperficial_Web$ = (void 0);
function $m_Lsuperficial_Web$() {
  if ((!$n_Lsuperficial_Web$)) {
    $n_Lsuperficial_Web$ = new $c_Lsuperficial_Web$().init___()
  };
  return $n_Lsuperficial_Web$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$e.Superficial = $m_Lsuperficial_Web$();
}).call(this);
